                                    ...
                                    <div className="single-post-wrap style-overlay">
                                        ...
                                        <div className="details pb-4">
                                            <div className="post-meta-single mb-2">
                                                <ul>
                                                    <li><a className="tag-base tag-red" href="#">Business</a></li>
                                                    <li><p><i className="fa fa-clock-o" />02.26.2024</p></li>
                                                    <li><i className="fa fa-user" />M. Bugucam</li>
                                                </ul>
                                            </div>
                                            <h5 className="title mt-0">Earning from Home in World of Remote Work</h5>
                                        </div>
                                    </div>
