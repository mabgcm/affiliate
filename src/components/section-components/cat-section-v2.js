					...
					<div className="col-xl-3 col-md-6">
						<div className="single-post-wrap style-overlay">
							<div className="thumb">
								...
								<Link className="tag-base tag-red" to="/cat-page">Business</Link>
							</div>
							<div className="details">
								<div className="post-meta-single">
									<p><i className="fa fa-calendar" />February 26, 2024</p>
								</div>
								<h6 className="title"><Link to="./posts/Earning">Earning from Home in World of Remote Work</Link></h6>
							</div>
						</div>
